...
Please ask [Peter](mailto:peter.ahumuza@epfl.ch) to add you to the CSCS project (send a message on Slack to get a faster answer). Once you have been added, check your mail for the invitation link. You will to have to create an account.
